...
import ru.practicum.android.diploma.util.temp_package_for_screen.fragments.FavoriteFragment
...
import ru.practicum.android.diploma.util.temp_package_for_screen.viewmodels.FilterViewModel
        ...
        return ComposeView(requireContext()).apply {
            ...
            setContent {
                FilterScreen(
                    ...
                    onWorkPlaceClick = { findNavController()
